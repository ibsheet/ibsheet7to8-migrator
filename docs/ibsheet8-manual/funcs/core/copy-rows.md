...
|----------|-----|---|----|
|rows|`object`|<span class='required'>필수</span>|[데이터 로우 객체](/docs/appx/row-object) 배열|
|next|`object`|<span class='optional'>선택</span>|[데이터 로우 객체](/docs/appx/row-object)<br/>(next로 지정한 행의 위에 rows행들이 복사됨. 값이 없으면 마지막 행에 복사)|
