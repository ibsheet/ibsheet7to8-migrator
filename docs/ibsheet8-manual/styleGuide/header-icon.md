...
<!-- synonyms: 스타일, 디자인, 테마, style, theme, 커스터마이징, 외관, 시트 스타일, 헤더 아이콘, header icon, 헤더 이미지 -->
...
|기본 테마|커스텀 적용|
|-----|-----|
|기본 테마의 필수 값 아이콘<br>![기본 테마의 필수 값 아이콘](/assets/imgs/styleguide_header_icon_req1.png "기본 테마의 필수 값 아이콘")|커스텀 필수 값 아이콘<br>![커스텀 필수 값 아이콘 적용](/assets/imgs/styleguide_header_icon_req2.png "커스텀 필수 값 아이콘 적용")|
...
|기본 테마|커스텀 적용 |
|-----|-----|
|기본 테마의 오름차순 아이콘<br>![기본 테마의 오름차순 아이콘](/assets/imgs/styleguide_header_icon_sort_asc1.png "기본 테마의 오름차순 아이콘")|커스텀 1순위 오름차순 아이콘<br>![커스텀 1순위 오름차순 아이콘 적용](/assets/imgs/styleguide_header_icon_sort_asc2.png "커스텀 1순위 오름차순 아이콘 적용")|
|기본 테마의 내림차순 아이콘<br>![기본 테마의 내림차순 아이콘](/assets/imgs/styleguide_header_icon_sort_desc1.png "기본 테마의 내림차순 아이콘")|커스텀 1순위 내림차순 아이콘<br>![커스텀 1순위 내림차순 아이콘 적용](/assets/imgs/styleguide_header_icon_sort_desc2.png "커스텀 1순위 내림차순 아이콘 적용")|
...
|기본 테마|커스텀 적용|
|-----|-----|
|기본 테마의 오름차순 아이콘<br>![기본 테마의 오름차순 아이콘](/assets/imgs/styleguide_header_icon_sort_asc1.png "기본 테마의 오름차순 아이콘")|커스텀 2순위 오름차순 아이콘<br>![커스텀 2순위 오름차순 아이콘 적용](/assets/imgs/styleguide_header_icon_sort_asc3.png "커스텀 2순위 오름차순 아이콘 적용")|
|기본 테마의 내림차순 아이콘<br>![기본 테마의 내림차순 아이콘](/assets/imgs/styleguide_header_icon_sort_desc1.png "기본 테마의 내림차순 아이콘")|커스텀 2순위 내림차순 아이콘<br>![커스텀 2순위 내림차순 아이콘 적용](/assets/imgs/styleguide_header_icon_sort_desc3.png "커스텀 2순위 내림차순 아이콘 적용")|
