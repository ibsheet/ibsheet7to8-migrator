...
<!--! > 대용량 모드에서는 [SearchMode:0](/docs/props/cfg/search-mode)은 데이터행의 높이에 동적인 경우에 대해 지원하지 않으므로 해당 기능을 사용할 수 없습니다.<br/>!-->

###
![Wrap:0(false)](/assets/imgs/wrap0.png "Wrap:0(false) 설정시")<br/>
[`Wrap:0(false)` 설정시]


![Wrap:1(true)](/assets/imgs/wrap1.png "Wrap:1(true) 설정시")<br/>
[`Wrap:1(true)` 설정시]
