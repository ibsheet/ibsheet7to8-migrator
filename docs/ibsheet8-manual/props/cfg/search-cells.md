...
|Value|Description|
|-----|-----|
|`0`|행 단위로 검색 (`default`)<br/> ex) 찾기 행에 "가방 영국" 입력 시 행 내 셀들 중 "가방"과 "영국"을 포함하는 셀이 하나 이상 있는 경우(한 셀이 "가방", 다른 한 셀이 "영국"을 가지는 경우도 포함) 해당 행이 검색됨|
|`1`|셀 단위로 검색<br/> ex) 찾기 행에 "가방 영국" 입력 시 "가방"과 "영국" 두 개의 단어를 모두 포함하는 셀만 검색됨|
