...
<!-- synonyms: NumberStrictMode, number-strict-mode, 숫자 엄격 모드, 숫자 검사 모드, NaN 처리, 숫자 타입 검사, 빈 값 0 처리, 천단위 구분자 처리, number strict mode, numeric validation, NaN handling, strict number check -->
